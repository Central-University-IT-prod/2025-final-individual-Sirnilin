...
def generate_ad():
    ...
    system_prompt = (
        ...
        "На основе описания кампании напиши креативный рекламный текст, который привлечёт внимание аудитории.(не более 3-4 предложений)"
    )
...
if __name__ == '__main__':
    app.run(debug=True, host='REDACTED')
